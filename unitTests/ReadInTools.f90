...
CALL FillStrings(FileName)

intOpt           = GETINT('intOpt'        )
intOpt_def       = GETINT('intOpt_def'    , '-1')
...
logOpt_def       = GETLOGICAL('logOpt_def'    , 'T')
...
strOpt_def       = GETSTR('strOpt_def'    , 'dummyValue')
...
intArrayOpt_def         = GETINTARRAY('intArrayOpt_def',3, '-1,0,-3')
DO i=1,3
...
realArrayOpt_def        = GETREALARRAY('realArrayOpt_def', 3, '-1.00,5.,22')
DO i=1,3
...
realArrayOpt_defsci     = GETREALARRAY('realArrayOpt_defsci', 2, '0.3e-7,-5e2')
DO i=1,2
